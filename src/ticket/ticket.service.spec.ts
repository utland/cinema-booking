...
describe("TicketService", () => {
    ...
    describe("create", () => {
        ...
        it("should throw ConflictException when seat is already reserved", async () => {
            ...
            await expect(service.create(userId, createTicketDto)).rejects.toThrow(ConflictException);
    ...
    describe("updateStatus", () => {
        ...
        it("should throw ConflictException when trying to set status to RESERVED", async () => {
            ...
            await expect(service.updateStatus(userId, updateStatusDto)).rejects.toThrow(ConflictException);
            expect(mockTicketRepo.save).not.toHaveBeenCalled();
        });
        ...
        it("should throw NotFoundException when ticket not found", async () => {
            ...
            await expect(service.updateStatus(userId, updateStatusDto)).rejects.toThrow(NotFoundException);
        });
    });
