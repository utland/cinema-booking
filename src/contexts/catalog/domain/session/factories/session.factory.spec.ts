...
import { HALL_REPOSITORY_TOKEN, HallRepository } from "../../hall/ports/hall.repository";
...
describe("SessionFactory", () => {
    ...
    describe("create", () => {
        ...
        it("should create a session when business rules pass", async () => {
            ...
            const bookingTime = new Date("2026-06-8T12:00:00Z");
        ...
        it("should throw NotFoundDomainException when hall does not exist", async () => {
            ...
            await expect(
                factory.create({
                    ...
                    bookingTime: new Date("2026-06-8T12:00:00Z")
                })
