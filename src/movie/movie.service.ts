...
export class MovieService {
    ...
    public async create(createMovieDto: CreateMovieDto): Promise<Movie> {
        const { rentStart, rentEnd } = createMovieDto;
        this.validateTime(rentStart, rentEnd);
    ...
    public async update(id: string, updateMovieDto: UpdateMovieDto): Promise<void> {
        const movie = await this.checkMovieState(id);

        const { rentStart, rentEnd } = updateMovieDto;
        this.validateTime(rentStart, rentEnd);
