...
const commands = [CreateHallHandler, DeleteHallHandler, UpdateHallInfoHandler, UpdateSeatsHandler];

const queries = [FindAllHallHandler, FindHallByIdHandler];

@Module({
    imports: [TypeOrmModule.forFeature([TypeOrmHall, TypeOrmSeat]), forwardRef(() => SessionModule)],
